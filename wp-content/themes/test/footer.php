                    ...
                    <div class="modal-product clearfix">
                        <div class="product-images">
                            <div class="main-image images">
                                <img alt="" src="<?php echo get_template_directory_uri() ?>/img/product/quickview.jpg">
                            </div>
                        </div><!-- .product-images -->
...
<script src="<?php echo get_template_directory_uri() ?>/lib/js/jquery.nivo.slider.js"></script>
